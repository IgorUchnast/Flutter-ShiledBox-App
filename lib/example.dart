...
import 'package:shield_box/api/shieldbox2.dart';
...
class ShieldBox2 extends StatefulWidget {
  const ShieldBox2({super.key});

  @override
  State<ShieldBox2> createState() => _HomePage1State();
}

class _HomePage1State extends State<ShieldBox2> {
  final ShiledBoxService1 _shieldBoxService1 = ShiledBoxService1();
  final GlobalKey<LineChartCurrnetViewState> lineChartKey = GlobalKey();
  int _selectedIndex = 0;
  @override
  void initState() {
    super.initState();
    _shieldBoxService1.startListening();
  }

  @override
  void dispose() {
    _shieldBoxService1.dispose();
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<ListOfShieldBox>(
        stream: _shieldBoxService1.shieldBoxStream,
